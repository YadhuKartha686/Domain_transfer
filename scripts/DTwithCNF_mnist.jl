...
chan_x = 1; chan_y = 1; L = 3; K = 11; n_hidden = 128 # Number of hidden channels in convolutional residual blocks
...
for e=1:n_epochs# epoch loop
  ...
  for b = 1:n_batches # batch loop
        @time begin
          ...
          lossA = Genloss(fake_outputA,fake_imagesAfromB)  #### log(1 - D(fake)) + mse ####
          lossB = Genloss(fake_outputB,fake_imagesAfromB)  #### log(1 - D(fake)) + mse ####
          f_all = norm(Zx)^2
